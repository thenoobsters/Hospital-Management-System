...
public partial class User_User_View_Appointment : System.Web.UI.Page
{
    ...
    public void SearchAppoinment()
    {
        ...
        SqlCommand command = new SqlCommand("Select * from Appointment where BookedBy='" + Session["Username"].ToString() + "'", Conn);
