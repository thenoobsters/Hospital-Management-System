<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Employee.master" AutoEventWireup="true" CodeFile="AddInPatient.aspx.cs" Inherits="Employee_AddInPatient" %>
                                    ...
                                    <div class="widget-main">
                                        <table class="table  table-bordered table-hover">
                                            <tr>
                                                ...
                                                <td>Patient ID</td>
                                                <td>
                                                    <asp:TextBox CssClass="form-control"  ID="txtid" runat="server" Enabled="false" required="true"></asp:TextBox>
                                                </td>
                                            </tr>
                                      ...
                                      <%--      <tr>
                                                <td>Age</td>
                                                <td>
                                                    <asp:TextBox CssClass="form-control" onKeyUp='this.value = this.value.toLowerCase();' ID="txtAge" runat="server" required="true"></asp:TextBox>
                                                </td>
                                            </tr>--%>
                                           ...
                                           <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:TextBox runat="server" CssClass="form-control" ID="txtnatproblem" />
                                                </td>
                                            </tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <asp:TextBox runat="server" CssClass="form-control date-picker" ID="txtAdmissiondate" data-date-format="dd/mm/yyyy" />
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-calendar bigger-110"></i>
                                                        </span>
                                                    </div>
